...
check('Gestor de recursos detecta, reemplaza y optimiza antes de importar', jsonStudioSource.includes('auditOrbitJsonResources') && jsonStudioSource.includes('replaceOrbitJsonFontResource') && navigationSource.includes('optimizeOrbitImageFile') && navigationSource.includes('orbitJsonResourceManager'));
check('Biblioteca de componentes reutiliza dependencias entre proyectos', JS_MODULES.includes('components/reusable-component-library.js') && navigationSource.includes('createReusableComponentPackage') && navigationSource.includes('prepareReusableComponentImport') && navigationSource.includes('data-component-library-view'));
