...
check('release v0.30 visible', labelMatch?.[1] === 'v0.30' && indexHtml.includes('<title>Orbit Design Studio — v0.30</title>') && indexHtml.includes('<span class="version-badge">v0.30</span>'));
...
check('CI publica artefacto v0.30', workflowSource.includes('Orbit-Netlify-v0.30') && workflowSource.includes("node-version-file: '.nvmrc'"));
