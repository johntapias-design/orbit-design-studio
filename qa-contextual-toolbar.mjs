...
try {
  ...
  const sharedClassesSuite=await evaluate(`(()=>{
    ...
    const astroFiles=qa.projectFiles();const layoutFile=astroFiles.find(f=>f.name==='src/layouts/BaseLayout.astro');const layoutContent=layoutFile?layoutFile.data:'';
