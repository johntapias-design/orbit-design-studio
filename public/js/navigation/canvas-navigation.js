...
function analyzeOrbitJsonSource({repair=false}={}){
  ...
  try{
    ...
    const migration=migrateOrbitJsonToV13(parsed.value);let candidate=migration.document;let validation=validateOrbitJsonV13(candidate);let repairResult={document:candidate,actions:[],changed:false};
